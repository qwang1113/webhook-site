    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-foreground/5 rounded-xl p-8 border border-foreground/10">
        ...
        <button
          ...
          className="w-full py-3 border border-foreground/20 rounded-lg hover:bg-foreground/5 transition-colors flex items-center justify-center gap-3 font-medium"
        >
